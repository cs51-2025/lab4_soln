...
Do you see a pattern in your implementations of
`min_option` and `plus_option`? How can we factor out similar code?

........................................................................
Exercise 5: Write a polymorphic higher-order function `lift_option` to
"lift" binary operations to operate on option type values, taking
three arguments in order: the binary operation (a curried function)
and its first and second arguments as option types. If both arguments
are `None`, return `None`.  If one argument is `None`, the function
should return the other argument. If neither argument is `None`, the
...
A problem with this implementation of `zip` is that, once again, its
